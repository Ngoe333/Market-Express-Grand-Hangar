function Footer() {
  return (
    <div className="bg-gradient-to-r from-[#FAFAFA] from-0% to-[#FCFCFC] to-100% ">
      <footer className="footer xl:px24 py-10 px-4 flex items-center justify-between">
        ...
        <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
          <a>
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="fill-current cursor-pointe text-green"
            >
          ...
          <a>
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="fill-current cursor-pointer text-green"
            >
